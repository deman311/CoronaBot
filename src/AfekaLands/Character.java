...
public class Character {
	...
	public String wear(Armor armor) {
		...
		updateStatus();
		if(lastArmor!=null)
			return "Successfully worn: " + armor.getName() + " instead of " + lastArmor.getName() + "! (Def change: " + (armor.getDEF()-lastArmor.getDEF()) + ")";
	...
	public String wear(Weapon weapon) {
		Weapon lastWEP=null;
		if(equipATK!=null) {
			lastWEP = CoronaBot.player1.equipATK;
			takeoff(CoronaBot.player1.equipATK);		
		}
		...
		updateStatus();
		if(lastWEP!=null)
			return "Successfully worn: " + weapon.getName() + " instead of " + lastWEP.getName() + "! (Atk change: " + (weapon.getDamage()-lastWEP.getDamage()) + ")";
	...
	public String wear(String item) {
		...
		if(weapon!=null ) {
			if(equipATK!=null) {
				lastWEP = CoronaBot.player1.equipATK;
				CoronaBot.player1.takeoff(CoronaBot.player1.equipATK);		
			}
			System.out.println(weapon.getName());
			equipATK = weapon;
			baseDMG += weapon.getDamage();
